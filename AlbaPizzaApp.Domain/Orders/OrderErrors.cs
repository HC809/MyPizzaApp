...
public static class OrderErrors
{
    ...
    public static readonly Error NotPendingToUpdate = new("Order.NotPendingToUpdate", "La orden no esta pendiente, por lo tanto no se puede actualizar.");
    public static readonly Error AlreadyCanceled = new("Order.AlreadyCanceled", "La orden ya fue cancelada previamente por otro usuario.");
}
